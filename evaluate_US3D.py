...
@torch.no_grad()
def validate_rs(model, left_dir, right_dir, disp_dir, mode='8bit', device='cuda', 
                max_disp=96, min_disp=-96, save_path=None, dataset_name='us3d', mixed_prec=False):
    ...
    print("Validation US3D: EPE %f, D1 %f, time: %f" % (total_epe, total_d1, avg_time))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--test_left_dir', default=f'dataset/US3D/test_all/left', help="")
    parser.add_argument('--test_right_dir', default=f'dataset/US3D/test_all/right', help="")
    parser.add_argument('--test_disp_dir', default=f'dataset/US3D/test_all/disp', help="")
